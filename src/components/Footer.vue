    ...
    <div class="inner">
      ...
      <section>
        ...
        <ul class="icons">
          ...
          <li>
            <a href="https://facebook.com" class="icon brands style2 fa-facebook-f">
              <span class="label">Facebook</span>
            </a>
          </li>
          <li>
            <a href="https://instagram.com" class="icon brands style2 fa-instagram">
          ...
          <li>
            <a href="mailto:chris@cardsbychris.co.uk" class="icon solid style2 fa-envelope">
      ...
      <ul class="copyright">
        <li>&copy; Cards by Chris. All rights reserved</li>
        <li>
          Design:
